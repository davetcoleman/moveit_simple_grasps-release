## moveit_simple_grasps (indigo) - 1.3.1-2

The packages in the `moveit_simple_grasps` repository were released into the `indigo` distro by running `/usr/bin/bloom-release moveit_simple_grasps -t indigo -r indigo --edit` on `Thu, 10 Dec 2015 18:28:14 -0000`
...
## moveit_simple_grasps (indigo) - 1.3.0-0

The packages in the `moveit_simple_grasps` repository were released into the `indigo` distro by running `/usr/bin/bloom-release moveit_simple_grasps -t indigo -r indigo` on `Sat, 05 Dec 2015 19:04:18 -0000`
...
## moveit_simple_grasps (indigo) - 1.2.1-0

The packages in the `moveit_simple_grasps` repository were released into the `indigo` distro by running `/usr/bin/bloom-release moveit_simple_grasps -t indigo -r indigo` on `Tue, 28 Oct 2014 04:32:13 -0000`
...
## moveit_simple_grasps (indigo) - 1.2.0-1

The packages in the `moveit_simple_grasps` repository were released into the `indigo` distro by running `/usr/bin/bloom-release moveit_simple_grasps -t indigo -r indigo --edit` on `Sat, 20 Sep 2014 00:44:32 -0000`
...
## moveit_simple_grasps (indigo) - 1.2.0-0
